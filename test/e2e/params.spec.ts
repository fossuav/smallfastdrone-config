...
// End-to-end coverage of the param browser: connect to SITL, flip
// into expert mode, navigate to /params, exercise filtering, editing,
// type-aware editors (chip suggestions, bitmask checkboxes), and the
// Apply pipeline.
