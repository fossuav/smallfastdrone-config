...
**Status 2026-09-04:** T1–T7 have all landed. Only the **lock step** remains, and it waits on F6. T2's identity half and T7's enable wizard have both run against a real drone; T3 is unit-tested only, deliberately — see its row.
